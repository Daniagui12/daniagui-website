...
const projects = [
  {
    ...
    description: "A real-time dashboard for monitoring ETL pipeline health and performance. Built with Python, Airflow, and Plotly.",
  ...
  },
  {
    ...
    description: "A bot that automatically cleans and validates incoming data streams. Implemented with Python and Docker.",
  ...
  },
  {
    ...
    description: "A scalable platform for real-time analytics on streaming data. Built with Spark and AWS Kinesis.",
  ...
  },
  {
    ...
    description: "A toolkit for building interactive data visualizations. Built with React and D3.js.",
